...
export default class BattleEngine {
    ...
    selectMove(playerMoveIndex) {
        ...
        if (firstPlayer === 'player') {
            this.useMove(this.playerActivePokemon, this.opponentActivePokemon, playerMove);
        }
        else {
            this.useMove(this.opponentActivePokemon, this.playerActivePokemon, opponentMove);
        }
    }
    log() {
